...
const getSocialAuthErrorMessage = (err, providerLabel) => {
  ...
  return err?.response?.data?.message || err?.message || `${providerLabel} login failed`;
};
    ...
    try {
      ...
      if (userData.role === 'student') {
        try {
          ...
          console.error('Failed to load student profile after login', profileErr);
        }
      }
        ...
        <Card className="p-8 shadow-lg border-0 ring-1 ring-border">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button 
              type="button" 
              variant="outline" 
              className="h-12 border-[1.5px] border-border/80 hover:border-accent/40 hover:bg-slate-50 flex items-center justify-center gap-3 transition-all rounded-xl shadow-sm hover:shadow-md"
            ...
            <Button 
              type="button" 
              variant="outline" 
              className="h-12 border-[1.5px] border-border/80 hover:border-slate-400 hover:bg-slate-50 flex items-center justify-center gap-3 transition-all rounded-xl shadow-sm hover:shadow-md"
